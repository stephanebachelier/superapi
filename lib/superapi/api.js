...
var serviceHandler = function(service) {
  ...
  return function(options) {
    ...
    return new Promise(function (resolve, reject) {
      var req = self.request(service, data, params, query);
...
Api.prototype = {
  ...
  request: function(id, data, params, query) {
    ...
    return this._request(method, this.buildUrl(id, params, query), data, options);
  },

  _request: function (method, url, data, opts) {
    opts = opts || {};
